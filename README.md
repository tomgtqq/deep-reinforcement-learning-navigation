...
### Introduction
The Project is for Udacity Deep Reinforcement learning nd. The Function Approximation is a Deep learning network. so Using Gradient descent method to trian an agent to navigate (and collect bananas!) in a large, square world .
